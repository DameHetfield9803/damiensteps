...
export default function App(){
    return(
        <div
            className={"text-center container mx-auto flex-auto p-6 text-wrap bg-gradient-to-r from-black to-gray-700 subpixel-antialiased min-w-full rounded-xl min-h-screen"}>
            <h1 className={"text-6xl text-amber-400 font-light"}><strong>This is a tutorial on stepping using
                DaisyUI.</strong></h1>
            <h2 className={"text-3xl text-wrap font-mono mt-6 text-teal-400"}>Prerequisites: React, Tailwind CSS,
                DaisyUI, react-type-animation.</h2>
            <ul className={"steps steps-vertical mt-4 text-lg font-mono mb-4"}>
            ...
            <p className={"font-mono text-lg text-wrap text-violet-300"}>You can change the numerics within the circle with this block of code</p>
            <code className={"text-yellow-400 text-lg text-wrap"}>{`<li data-content="INSERT CONTENT"></li>`}</code>
            <br/>
            <code className={"text-orange-400 text-lg text-wrap"}>{`<li data-content=""></li>`} //if you want to leave it blank</code>
        </div>
    )
}
